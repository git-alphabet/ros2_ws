...
{
class RmucSubRobotStatusAction : public BT::RosTopicSubNode<rm_decision_interfaces::msg::RMUCRobotStatus>
{
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<std::shared_ptr<rm_decision_interfaces::msg::RMUCRobotStatus>>("robot_status")};
  }
