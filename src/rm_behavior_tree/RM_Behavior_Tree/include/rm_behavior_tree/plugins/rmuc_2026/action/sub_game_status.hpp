...
{
class RmucSubGameStatusAction : public BT::RosTopicSubNode<rm_decision_interfaces::msg::RMUCGameStatus>
{
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<rm_decision_interfaces::msg::RMUCGameStatus>("game_status"),
      BT::OutputPort<std::uint64_t>("now_ms")};
  }

  BT::NodeStatus onTick(
    const std::shared_ptr<rm_decision_interfaces::msg::RMUCGameStatus> & last_msg) override;
};
}  // namespace rm_behavior_tree
