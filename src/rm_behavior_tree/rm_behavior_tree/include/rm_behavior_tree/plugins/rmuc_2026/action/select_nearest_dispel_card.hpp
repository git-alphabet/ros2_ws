...
{
/// 从补给区/基地增益区/前哨增益区中选择距自身最近的祛弱卡点
class SelectNearestDispelCardAction : public BT::SyncActionNode
{
public:
  SelectNearestDispelCardAction(const std::string & name, const BT::NodeConfig & conf);
