...
{
class SubRobotStatusAction : public BT::RosTopicSubNode<rm_decision_interfaces::msg::RMULRob>
{
public:
  ...
  static BT::PortsList providedPorts()
  {
    return {
      ...
      BT::OutputPort<std::shared_ptr<rm_decision_interfaces::msg::RMULRob>>("robot_status")};
  }
